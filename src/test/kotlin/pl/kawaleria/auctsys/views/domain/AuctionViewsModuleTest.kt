...
class AuctionViewsModuleTest {
    ...
    val clock = MutableClock(LocalDateTime.of(2023, 10, 10, 23, 0).toInstant(ZoneOffset.UTC), ZoneId.of("UTC"))
    ...
    fun `should get most viewed auctions from ip address`() {
        ...
        val recentViewsFromIpAddressForAuction = auctionViewsQueryFacade.getMostViewedAuctionsFromIpAddress(ipAddress = ipAddress)
