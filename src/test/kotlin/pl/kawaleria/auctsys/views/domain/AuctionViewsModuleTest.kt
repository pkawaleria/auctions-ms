...
//
//    private val clock = MutableClock(LocalDateTime.of(2023, 10, 10, 23, 0).toInstant(ZoneOffset.UTC), ZoneId.of("UTC"))
...
//
//        // then
//        val recentViewsFromIpAddressForAuction: AuctionViewsFromIpResponse = auctionViewsQueryFacade.getRecentViewsFromIpAddressForAuction(
...
//        )
//
//        val differences: List<Duration> = recentViewsFromIpAddressForAuction.viewsTimestamps.zipWithNext()
//            .map { (first: Instant, second: Instant) -> Duration.between(first, second) }
//
...
//
//        // when
//        val recentViewsFromIpAddressForAuction: List<AuctionViewsFromIpResponse> = auctionViewsQueryFacade.getMostViewedAuctionsFromIpAddress(ipAddress = ipAddress)
//
//        // then
...
//
//        Assertions.assertThat(auctionViewsQueryFacade.getRecentViewsFromIpAddress(auctionViewedFromIp.ipAddress))
//            .containsExactly(auctionViewedFromIp.ipAddress)
//    }
//
//    @Test
